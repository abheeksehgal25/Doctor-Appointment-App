...
- Displays detailed information about the selected doctor:
  ...
  - Online payment options: **Cash or Stripe**.
...
3. **Environment Variables**:
  ...
  # RAZORPAY removed. Add payment provider keys as needed.
     ```
...
- Thanks to the developers and contributors of MongoDB, Express.js, React.js, Node.js, and Stripe for their fantastic tools and libraries.
